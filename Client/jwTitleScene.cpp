...
namespace jw
{
	...
	void TitleScene::Initialize()
	{
		...
		mImage2 = Resources::Load<Image>(L"Background2", L"..\\Resources\\Image\\Title_Screen\\Background\\title_chips_left_0001 #262672.png");
	}
	...
	void TitleScene::Render(HDC hdc)
	{
		...
		//GdiTransparentBlt(hdc, 140, 720, mImage2->GetWidth(), mImage2->GetHeight(), mImage2->GetHdc(), 0, 0, mImage2->GetWidth(), mImage2->GetHeight(), RGB(255, 0, 255));

		Graphics graphic(hdc);
		graphic.DrawImage(mImage2->GetImage(), 140, 720, mImage2->GetWidth(), mImage2->GetHeight());;
